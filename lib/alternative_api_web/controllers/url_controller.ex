defmodule AlternativeApiWeb.UrlController do
  use AlternativeApiWeb, :controller

  alias AlternativeApi.Urls
  alias AlternativeApi.Urls.Url

  action_fallback AlternativeApiWeb.FallbackController
